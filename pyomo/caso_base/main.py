...
def construccion_modelo(clientes, depositos, parametros, vehiculos):
    ...
    matriz_distancia_tiempo = pd.read_csv("pyomo/caso_base/matriz.csv")
    for i in model.D:
        for j in model.C:
...
if __name__ == "__main__":
    ...
    solver = SolverFactory('appsi_highs')  # Asegúrate de tener Highspy o glpk instalado
    ...
    #export csv
    data_frame.to_csv('pyomo/caso_base/verificacion_caso1.csv', sep=',', index=False)
